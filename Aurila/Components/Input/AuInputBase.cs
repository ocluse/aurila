...
public abstract class AuInputBase<TControl, TValue> : AuControlBase<TControl>, IValidatable, IFormControl, IDisposable, IInputComponent, IFocusable
    where TControl : AuInputBase<TControl, TValue>
{
