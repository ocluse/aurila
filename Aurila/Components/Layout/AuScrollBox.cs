...
public sealed class AuScrollBox : AuControlBase<AuScrollBox>, IScrollController, IAsyncDisposable, IHasMargin, IHasPadding
{
    [Parameter]
    ...
    private DotNetObjectReference<AuScrollBox>? _dotNetObjRef;
